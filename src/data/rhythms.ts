...
export const PREDEFINED_RHYTHMS: CategorizedRhythm[] = [
  ...
  // === BASS ===
  {
    ...
    pattern: { steps: ['4n.', '8n', '4n.', '8n'], subdivision: '16n' }
  },
  {
    name: 'Dubstep Drop',
    category: 'bass',
    description: 'Heavy syncopated dubstep like',
    pattern: { steps: ['8n', '16n', '16n', '8n.', '16n', '8n', '8n'], subdivision: '16n' }
  },
  {
    name: 'Four on the Floor',
    category: 'bass',
    description: 'Classic steady bass pulse',
    pattern: { steps: ['4n', '4n', '4n', '4n'], subdivision: '16n' }
  },
  {
    name: 'Gothic March',
    category: 'bass',
    description: 'A slow, somber, and heavy procession',
    pattern: { steps: ['4n.', '8n', '4n', '4n'], subdivision: '16n' }
  },
  {
    name: 'Metal Gallop',
    category: 'bass',
    description: 'Iconic fast-paced heavy metal rhythm',
    pattern: { steps: ['8n', '16n', '16n', '8n', '16n', '16n', '4n'], subdivision: '16n' }
  },
  {
    name: 'Reggae Bass',
    category: 'bass',
    description: 'Offbeat reggae groove',
    pattern: { steps: ['8n', '8n.', '16n', '8n', '8n.', '16n'], subdivision: '16n' }
  },
  {
    name: 'Rolling Bass',
    category: 'bass',
    description: 'A rolling, syncopated bassline',
    pattern: { steps: ['16n', '16n', '16n', '16n', '16n', '16n', '16n', '16n'], subdivision: '16n' }
  },
  {
    name: 'Retro Funk Bass',
    category: 'bass',
    description: 'A groovy, syncopated bassline straight from the 80s',
    pattern: { steps: ['8n', '16n', '16n', '4n', '8n', '4n'], subdivision: '16n' }
  },
  {
    name: 'Solemn Drone',
    category: 'bass',
    description: 'A slow, minimalist pulse for deep and somber basslines',
    pattern: { steps: ['2n', '2n'], subdivision: '16n' }
  },
  {
    name: 'Walking Bass',
    category: 'bass',
  ...
  // === WORLD ===
  {
    ...
    pattern: { steps: ['8n', '4n', '8n', '8n', '4n'], subdivision: '16n' }
  },
  {
    name: 'Balkan Rhythm',
    category: 'world',
    description: 'Eastern European odd meter',
    pattern: { steps: ['8n', '8n', '8n', '16n', '16n', '8n', '8n'], subdivision: '16n' }
  },
  {
    name: 'Clavé Son (3-2)',
    category: 'world',
    description: 'Cuban son clave',
    pattern: { steps: ['8n.', '8n.', '4n', '8n', '8n'], subdivision: '16n' }
  },
  {
    name: 'Habanera',
    category: 'world',
    description: 'Spanish dance rhythm',
    pattern: { steps: ['8n', '16n', '16n', '8n', '8n'], subdivision: '16n' }
  },
  {
    name: 'Indian Tala',
    category: 'world',
    description: 'Classical Indian rhythm',
    pattern: { steps: ['4n', '8n', '8n', '4n', '8n'], subdivision: '16n' }
  },
  {
    name: 'Rumba Clave',
    category: 'world',
    description: 'Afro-Cuban clave pattern',
    pattern: { steps: ['8n.', '16n', '8n', '8n.', '16n'], subdivision: '16n' }
  },
  {
    name: 'Samba Groove',
    category: 'world',
    description: 'Brazilian carnival rhythm',
    pattern: { steps: ['16n', '8n', '16n', '8n', '16n', '8n', '8n'], subdivision: '16n' }
  },
  {
    name: 'The Tresillo',
    category: 'world',
    description: 'Cuban rhythm pattern',
    pattern: { steps: ['8n.', '8n.', '4n'], subdivision: '16n' }
  }
]
